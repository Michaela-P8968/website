...
life_expectancy <- read.csv("~/Desktop/website/content/life-expectancy.csv")
health_expenditure <- read.csv("~/Desktop/website/content/health_expenditure.csv")
country_info <- read.csv("~/Desktop/website/content/Country_Region_and_Income_Group.csv")
